...
/**
 * Evo UG played on a square grid with the action of abstinence available. After determining that an offer is
 * does not rise above their acceptance threshold, a responder will abstain if the loner's payoff is a better
 * deal than the proposed offer.
 *
 * Initial conclusions: similar conclusions to those of AbstainSpatialEvoUG1.java
 */
